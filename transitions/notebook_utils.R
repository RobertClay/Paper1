...
format_baseline_data <- function(source, years){
  ...
  #columns <- c("pidp", "SF.12", "job_sec","education_state", "sex",
  ...
  #who_1 <- which(data$depression_change == "Not at all")
  #who_2 <- which(data$depression_change == "No more than usual")
  #who_3 <- which(data$depression_change == "Rather more than usual")
  #who_4 <- which(data$depression_change == "Much more than usual")
  
  #data[who_1,]$depression_change <- 1
  #data[who_2,]$depression_change <- 2
  #data[who_3,]$depression_change <- 3
  #data[who_4,]$depression_change <- 4
  #data$depression_change <- as.numeric(data$depression_change)
  return(data)  
}
